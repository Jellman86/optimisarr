...
- Media-server and notification switches now span their Settings cards, advanced library quality controls wrap on small screens, and the Personal quality check stacks its side panel when enlarged text reduces available space.
