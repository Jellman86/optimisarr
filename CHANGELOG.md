...
- An optional per-library maximum allowed saving for video re-encodes. At 65%, a finished candidate below 35% of the source size fails before VMAF on the container or updated sidecars. The original is retained; blank leaves compression unrestricted. Minimum and maximum targets cannot conflict.
