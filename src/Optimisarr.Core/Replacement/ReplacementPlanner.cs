...
/// The original is quarantined under a timestamped folder so repeated replacements
/// of same-named files never collide and rollback always has a unique source.
/// </summary>
public static class ReplacementPlanner
{
        ...
        DateTimeOffset nowUtc)
    {
        ...
        var quarantinePath = Path.Combine(trashRoot, stamp, Path.GetFileName(originalPath));
