...
public enum RuleProfile
{
    ...
    /// <summary>
    /// "Scott's Settings": conservative HEVC video that tone-maps HDR to SDR and re-encodes audio
    /// to AAC 96 kbps downmixed to stereo — a compatibility-first, space-saving bundle.
    /// </summary>
    ScottsSettings = 4,
