...
| Personal quality check | A per-library comparison with one marked original reference and anonymous media-specific candidates. It can recommend a video preset, audio bitrate, or image quality; its disposable samples cannot enter replacement. |
