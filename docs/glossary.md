...
| Personal quality check | A per-library anonymous A–F comparison containing one unmarked original and five quality candidates. It can recommend a video quality, audio bitrate, or image quality; its disposable samples cannot enter replacement. |
