...
| Personal quality check | A per-library comparison with one marked original reference and five anonymous quality candidates A–E. It can recommend a video quality, audio bitrate, or image quality; its disposable samples cannot enter replacement. |
